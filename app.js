...
app.get("/search", async function(req, res) {
    ...
    console.log(`imageUrl: ${imageUrlArray}`);
...
function getRandomImage(keyword, count) {
    return new Promise(function(resolve, reject) {
        let requestUrl = `https://api.unsplash.com/photos/random/?count=${count}&client_id=4uKWATBqaBm2P2DW3851jhsw3VASGIj7OYNDpSLgwUM&featured=true&orientation=landscape&query=${keyword}`;
